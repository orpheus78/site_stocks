...
/**
 * Avisos de stock devolvidos por POST /api/consumos.
 *
 * REGRA DE NEGOCIO: sao SEMPRE informativos. O consumo ja foi registado quando o
...
const { descreverAvisoStock } = require('../../src/services/consumos.service');
...
describe('consumos.service.descreverAvisoStock — sem nada a assinalar', () => {
...
describe('consumos.service.descreverAvisoStock — stock baixo', () => {
  test('Dado um consumo que faz o stock cair abaixo do minimo, gera aviso do tipo stock_baixo', () => {
...
describe('consumos.service.descreverAvisoStock — stock negativo', () => {
