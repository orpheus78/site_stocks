...
const { calcularPagamento } = require('../../src/services/vendas.service');
const { AppError } = require('../../src/services/AppError');

describe('vendas.service.calcularPagamento — movimento interno', () => {
...
describe('vendas.service.calcularPagamento — pagamento em dinheiro', () => {
  ...
  test('Dado dinheiro entregue insuficiente para o total, rejeita a venda', () => {
...
describe('vendas.service.calcularPagamento — pagamento multibanco', () => {
...
describe('vendas.service.calcularPagamento — pagamento misto', () => {
  test('Dado pagamento misto sem valor em dinheiro, rejeita a venda', () => {
    const total = 10;
    assert.throws(
  ...
  test('Dado pagamento misto sem valor em multibanco, rejeita a venda', () => {
    const total = 10;
    assert.throws(
  ...
  test('Dado pagamento misto em que a soma total entregue e insuficiente, rejeita a venda', () => {
    const total = 20;
    assert.throws(
      () =>
...
describe('vendas.service.calcularPagamento — metodo invalido', () => {
  test('Dado um metodo de pagamento desconhecido, rejeita a venda', () => {
    assert.throws(
