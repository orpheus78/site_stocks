...
} = require('../../src/services/vendas.service');
const { AppError } = require('../../src/services/AppError');

describe('vendas.service.agregarItens', () => {
...
describe('vendas.service.calcularSubtotal', () => {
...
describe('vendas.service.calcularTotalCarrinho', () => {
